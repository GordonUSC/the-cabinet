...
function start(){
 ...
 host.innerHTML='<a class="ggp-mode-brand" href="index.html#donors" aria-label="GGP donor prototype">GGP<span>↗</span><small>DIRECTORY + PIPELINE</small></a><nav aria-label="GGP experiences"><a data-mode="student" href="student.html">Student</a><a data-mode="educator" href="educator.html">Educator</a><a data-mode="donor" href="index.html#donors">Donor</a><a data-mode="ahead" href="pilot-review.html">Possibilities ahead</a></nav><span class="ggp-mode-state">PROTOTYPE · FOR REVIEW</span>';
